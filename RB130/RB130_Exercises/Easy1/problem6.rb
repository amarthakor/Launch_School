...
#  It should return true if the block returns true for 
#  any of the element values. Otherwise, it should return false.
...
def any?(numbers)
  numbers.each { |num| return true if yield(num) }
  false
end
