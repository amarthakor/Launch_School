...
separate class called WheeledVehicle. This is what their code looks 
like so far:
...
- Create module
  - module should contain common functionality to all three classes
  - share common functioanlity between all three classes
=end
...
lambo = Catamaran.new(3, 2, 10, 10.0)
puts lambo.range